 ...
 * стоят между открытием PR и мёрджем: версия пишется коммитом в ветку уже
 * открытого PR, поэтому раньше её ставить некуда, а позже — поздно. Шаг
 * обновления плагинов идёт после мёрджа: он переводит плагины на смёрдженный
 * код.
 */
