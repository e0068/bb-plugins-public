/* shadcn/ui-derived, from the @bb plugin registry. Portalled like the plugin's
   hover card, and with an Anchor so a popover can point at an element it does
   not own — a row of the host's own sidebar. */
