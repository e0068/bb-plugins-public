    ...
    <Dialog open={open} onOpenChange={requestClose}>
      ...
      >
        ...
        >
          ...
          >
            <SelectTrigger aria-label="Type" className={CHIP_TRIGGER}>
          ...
          <Select
            ...
            onValueChange={(value) => setEstimate(value as TaskEstimate)}
          >
            <SelectTrigger aria-label="Estimate" className={CHIP_TRIGGER}>
              <SelectValue placeholder="Estimate" />
            </SelectTrigger>
            <SelectContent>
              {TASK_ESTIMATES.map((value) => (
                <SelectItem key={value} value={value}>
